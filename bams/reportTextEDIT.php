  ...
  <div class="mainSection"><!-- InstanceBeginEditable name="MainSectionBody" -->
    <form action="<?php echo $editFormAction; ?>" method="post" name="form1" id="form1">
      <table class="tableForm">
        ...
        <tr>
          <td colspan="2" class="tableForm"><textarea name="textBlock" id="textBlock">
          <?php echo $row_rs_textBlock['textBlock']; ?></textarea>
          	<script type="text/javascript">
          		CKEDITOR.replace( 'textBlock',
          			{
          	        	height: 600,
          	        	width: 800
          		    });
    ...
    <br /><br />
    <a href="/ckeditor/samples/">CKeditor</a>
